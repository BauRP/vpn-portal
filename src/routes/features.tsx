...
export const Route = createFileRoute("/features")({
  head: () => ({
    meta: [
      { title: "Features — Trivo VPN" },
      {
        name: "description",
        content:
          "Inside the Trivo VPN stealth engine: VLESS over WebSocket TLS, Shadowsocks, WireGuard and RAM-only persistence.",
      },
      { property: "og:title", content: "Features — Trivo VPN" },
      {
        property: "og:description",
        content:
          "VLESS / WS / TLS, Shadowsocks, WireGuard, encrypted DNS, RAM-only.",
      },
    ],
  }),
